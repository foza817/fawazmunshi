...
return '💱*│* تم وضـع شـرط التفعيل البوت اذا كانت المـجمـوعه آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end
...
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : فواز منشي](https://t.me/adnanrefaeii2)',nil,inline,msg.id_)
return false
end
...
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
3- ❴ اوامـر الحظـر والطــرد والتقييد ❵
...
٣- وارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القروب تلقائيا
مطور البوت DEV @FOZA817
